...
describe('Validate JS configs', () => {
  it('Validate eslint-config-zackcode', async () => {
  ...
  it('Validate eslint-config-zackcode/es5', async () => {
  ...
  it('Validate eslint-config-zackcode/vue', async () => {
  ...
  it('Validate eslint-config-zackcode/essential', async () => {
  ...
  it('Validate eslint-config-zackcode/essential/es5', async () => {
  ...
  it('Validate eslint-config-zackcode/essential/react', async () => {
  ...
  it('Validate eslint-config-zackcode/essential/vue', async () => {
  ...
  it('Validate eslint-config-zackcode/node', async () => {
