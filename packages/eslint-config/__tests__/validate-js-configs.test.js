...
describe('Validate JS configs', () => {
	it('Validate sunny586-fe-eslint-config', async () => {
	...
	it('Validate sunny586-fe-eslint-config/es5', async () => {
	...
	it('Validate sunny586-fe-eslint-config/vue', async () => {
	...
	it('Validate sunny586-fe-eslint-config/essential', async () => {
	...
	it('Validate sunny586-fe-eslint-config/essential/es5', async () => {
	...
	it('Validate sunny586-fe-eslint-config/essential/react', async () => {
	...
	it('Validate sunny586-fe-eslint-config/essential/vue', async () => {
	...
	it('Validate sunny586-fe-eslint-config/node', async () => {
