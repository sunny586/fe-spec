...
describe('Validate JS configs', () => {
	it('Validate eslint-config-zack', async () => {
	...
	it('Validate eslint-config-zack/es5', async () => {
	...
	it('Validate eslint-config-zack/vue', async () => {
	...
	it('Validate eslint-config-zack/essential', async () => {
	...
	it('Validate eslint-config-zack/essential/es5', async () => {
	...
	it('Validate eslint-config-zack/essential/react', async () => {
	...
	it('Validate eslint-config-zack/essential/vue', async () => {
	...
	it('Validate eslint-config-zack/node', async () => {
