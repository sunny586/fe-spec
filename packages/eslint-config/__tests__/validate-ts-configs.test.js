...
describe('Validate TS configs', () => {
  it('Validate eslint-config-zackcode/typescript', async () => {
  ...
  it('Validate eslint-config-zackcode/typescript/vue', async () => {
  ...
  it('Validate eslint-config-zackcode/essential/typescript', async () => {
  ...
  it('Validate eslint-config-zackcode/essential/typescript/react', async () => {
  ...
  it('Validate eslint-config-zackcode/essential/typescript/vue', async () => {
  ...
  it('Validate eslint-config-zackcode/typescript/node', async () => {
