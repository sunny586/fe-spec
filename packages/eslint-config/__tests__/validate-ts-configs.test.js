...
describe('Validate TS configs', () => {
  it('Validate sunny586-fe-eslint-config/typescript', async () => {
  ...
  it('Validate sunny586-fe-eslint-config/typescript/vue', async () => {
  ...
  it('Validate sunny586-fe-eslint-config/essential/typescript', async () => {
  ...
  it('Validate sunny586-fe-eslint-config/essential/typescript/react', async () => {
  ...
  it('Validate sunny586-fe-eslint-config/essential/typescript/vue', async () => {
  ...
  it('Validate sunny586-fe-eslint-config/typescript/node', async () => {
