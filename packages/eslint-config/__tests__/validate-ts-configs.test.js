...
describe('Validate TS configs', () => {
	it('Validate eslint-config-zack/typescript', async () => {
	...
	it('Validate eslint-config-zack/typescript/vue', async () => {
	...
	it('Validate eslint-config-zack/essential/typescript', async () => {
	...
	it('Validate eslint-config-zack/essential/typescript/react', async () => {
	...
	it('Validate eslint-config-zack/essential/typescript/vue', async () => {
	...
	it('Validate eslint-config-zack/typescript/node', async () => {
