...
`sunny586-fe-lint` 是[印客学院 前端编码规范工程化](https://encode-studio-fe.github.io/fe-spec/)的配套 Lint 工具，可以为项目一键接入规范、一键扫描和修复规范问题，保障项目的编码规范和代码质量。
...
- 安装各种依赖：包括 `Linter` 依赖，如 [ESLint](https://eslint.org/)、[stylelint](https://stylelint.io/)、[commitlint](https://commitlint.js.org/#/)、[markdownlint](https://github.com/DavidAnson/markdownlint) 等；配置依赖，如 [eslint-config-zack](https://www.npmjs.com/package/eslint-config-zack)、[stylelint-config-encode](https://www.npmjs.com/package/stylelint-config-encode)、[commitlint-config-encode](https://www.npmjs.com/package/commitlint-config-encode)、[sunny586-fe-markdownlint-config](https://www.npmjs.com/package/sunny586-fe-markdownlint-config) 等
- 写入各种配置文件，包括：
...
#### `sunny586-fe-lint commit-file-scan` 提交文件扫描
